...
public abstract class Fahrzeug {
	...
	//Konstruktor Fahrzeug (Keine Fahrzeug Objekte -> abstract).
	...
	public double fahren(double minuten) {
		...
		tempPosition += ((tempCurrentSpeed * minuten *60) / 1000.0);
	 ...
	 * Vollbremsung ausgelöst. Als Resultat wird der Anhalteweg in m
	 * zurückgeliefert.
	 */
	...
	public String toString() {
		...
		b.append(name + "\t");
		b.append("AktuellePosition: " + Math.round(position*100.0)/100.0 +"km" + "\t");
		b.append("AktuelleGeschwindigkeit: " + Math.round(geschwindigkeit*100.0)/100.0 +"km/h" +"\t");
		b.append("Anhalteweg: " + Math.round(anhalteweg*100.0)/100.0 +"m");
		return b.toString();
	}
