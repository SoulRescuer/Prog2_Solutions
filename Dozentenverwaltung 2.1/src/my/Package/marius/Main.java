...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student aStudent = new Student("Peter", "Müller", "Hauptstrasse", 4, 96450, "Coburg", 455555, 1000 );
		...
		Dozent bDozent = new Dozent("Dozent", "Nachname", "Dozentstraße", 3, 96450, "Coburg", "Betriebssysteme", 1 );
